...
const LoginPage = ({ onLogin }) => {
  ...
  // 1. Get the Hostname (e.g. "192.168.1.5")
  const domain = window.location.hostname;
  
  // 2. Build the Base URL correctly
    ...
    <div className="login-page">
        ...
        <div className="login-card">
            ...
            <form onSubmit={handleSubmit} className="login-form">
                ...
                {isSignup && <input className="input-field" type="email" placeholder="Email (Optional)" value={email} onChange={e => setEmail(e.target.value)} />}
                <input className="input-field" type="password" placeholder="Password" value={password} onChange={e => setPassword(e.target.value)} required />
                {isSignup && <input className="input-field" type="password" placeholder="Confirm Password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} required />}
